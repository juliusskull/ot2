...
public class SincronizarListAdapter extends BaseAdapter {
	...
	private List<Sincronizar>data;
	private ArrayList<Sincronizar> tipoarray;
	private Cursor cursor;


	public SincronizarListAdapter(Context context, int layoutResourceId,
			List<Sincronizar> data) {
		this.layoutResourceId=layoutResourceId;
		this.context = context;
		this.tipoarray = new ArrayList<Sincronizar>();
		//this.data = new ArrayList<Sincronizar>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.place.setText(data.get(position).getSincronizar());
	...
	@Override
	public Sincronizar getItem(int position) {
