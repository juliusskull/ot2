...
public class MotivosotListAdapter extends BaseAdapter {

	private final Context context;
	int layoutResourceId;
	private List<Motivosot>data;
	private ArrayList<Motivosot> tipoarray;
	private Cursor cursor;


	public MotivosotListAdapter(Context context, int layoutResourceId,
			List<Motivosot> data) {
		this.layoutResourceId=layoutResourceId;
		this.context = context;
		this.tipoarray = new ArrayList<Motivosot>();
		//this.data = new ArrayList<Motivosot>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.place.setText(data.get(position).getDesc_motivo());
	...
	@Override
	public Motivosot getItem(int position) {
