...
public class EditorListAdapter extends BaseAdapter {
	...
	private List<Editor>data;
	private ArrayList<Editor> tipoarray;
	private Cursor cursor;


	public EditorListAdapter(Context context, int layoutResourceId,
			List<Editor> data) {
		this.layoutResourceId=layoutResourceId;
		this.context = context;
		this.tipoarray = new ArrayList<Editor>();
		//this.data = new ArrayList<Editor>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.place.setText(data.get(position).getTitulo());
